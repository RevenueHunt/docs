...
=== "Shopify V2"
    ...
    1. You can add it to the quiz from the [Quiz Builder](/reference/quiz-builder/) tab by clicking on the `+ Add Question` button and selecting the email question type.
    2. You can [ask for marketing consent](/how-to-guides/ask-for-marketing-consent/) directly in the quiz. For example:
        ...
        - Or you can add a marketing consent checkbox in the email question settings.
...
=== "Shopify V2"
    ...
    Remember to deactivate the email notifications from the quiz settings once the Klaviyo flow is set up.
...
=== "Shopify V2"
    ...
    3. Allow `Full access`.
    4. Copy the private key.
    5. In the app navigation, go to `Integrations > Marketing` and click on Klaviyo.
    6. Paste your Private API Key.
    7. Choose to `mark all profiles as true` and select a list that contacts should be added to.
    ...
    9. Save your changes.
    10. Remember to test the connection with a sample email.
