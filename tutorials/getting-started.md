...
Before you start collecting leads and generating sales, here's a quick tour to help you find your way around the RevenueHunt app.
...
=== "Shopify"
    ...
    2. When you log in to the RevenueHunt app, the first thing you'll see is your [Dashboard](/reference/dashboard/). This is where you can find all the [quizzes that you create](/reference/dashboard/#quizzes).
...
=== "Shopify"
    ...
    Once you're happy with the quiz design, click on open the [choice settings](/reference/quiz-builder/questions/#choice-settings) > [Upvote](/reference/quiz-builder/link-products/#upvote) to add products and collections to each question.
...
=== "Shopify"
    ...
    1. Head to [`Design`](/reference/quiz-builder/quiz-design/). In the [Theme Gallery](/reference/quiz-builder/quiz-design/#my-themes), you'll find ready-made themes to choose from, or you can [create your own](/reference/quiz-builder/quiz-design/#edit-theme).
...
=== "Shopify"
    ...
    When you're ready to go live, head to the [`Publish`](/reference/quiz-builder/share-publish/) section. From your quiz dashboard, you'll find instructions to embed your quiz on your website—whether that's through a [menu link](/reference/quiz-builder/share-publish/#link), a "Take the Quiz" button, [inline on a page](/reference/quiz-builder/share-publish/#inline), or as an automatic popup. 
...
=== "Shopify"
    ...
    - To set this up, select a platform like Klaviyo, Zapier, or Meta Pixel and click `connect`. 
...
=== "Shopify"
    ...
    - You can [download all responses to a CSV file](/how-to-guides/download-quiz-responses/) by clicking on the export button.
