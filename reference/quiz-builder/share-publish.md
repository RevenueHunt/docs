...
=== "Shopify" 
    ...
    !!! info "What is a Link Popup?"
        ...
        A link that opens the quiz as a popup over your page.
...
=== "Shopify"
    ...
    !!! info "What is an Inline Quiz?"
        ...
        A quiz embedded inline with a page.
...
=== "Shopify"
    ...
    !!! info "What is an Automatic Popup?"
        ...
        A quiz popup that appears after X seconds. It is shown once per session, unless `Exit Intent` is enabled in the popup settings.
...
=== "Shopify"
    ...
    !!! info "What is an External Link?"

        A direct link to the quiz, for social media.

    There are two ways to create an external link for your quiz:

    - [Dedicated Quiz Page](#external-dedicated-quiz-page)
    - [Link Popup for Socials](#external-link-popup-for-socials)

    **Dedicated quiz page**{ #external-dedicated-quiz-page }

    Create a dedicated quiz page, for example `https://yourstore.myshopify.com/pages/quiz-page`. Embed the quiz on that page, then share the link on social media.

    !!! tip "Step-by-step instructions"

        For step by step instructions, check [Inline Quiz on a Specific Page](/reference/quiz-builder/share-publish/#inline-on-a-specific-page).

    **Link popup for socials**{ #external-link-popup-for-socials }

    This method involves activating the `Link Popup Quiz` app embed in your store theme and then adding a `#quiz` to any URL. For example, `https://yourstore.myshopify.com/#quiz` can open the quiz as long as the `Link Popup Quiz` app embed is activated. You can use this URL to share the quiz on social media.
...
=== "Shopify"
    ...
    !!! info "What is an Email Link?"
        ...
        A direct link to the quiz, for emails.

    There are two ways to create an external email link for your quiz:

     - [Dedicated Quiz Page](#email-dedicated-quiz-page)
     - [Link Popup for Socials](#email-link-popup-for-socials)

    **Dedicated quiz page**{ #email-dedicated-quiz-page }

    Create a dedicated quiz page, for example `https://yourstore.myshopify.com/pages/quiz-page`. Embed the quiz on that page, then share the link in your emails.
    ...
    **Link popup for socials**{ #email-link-popup-for-socials }
    ...
    This method involves activating the `Link Popup Quiz` app embed in your store theme and then adding a `#quiz` to any URL. For example, `https://yourstore.myshopify.com/#quiz` can open the quiz as long as the `Link Popup Quiz` app embed is activated. You can use this URL to share the quiz in your emails.
...
=== "Shopify (Legacy)" 
    ...
    !!! info "What is an Email Link?"
        ...
        A quiz popup that opens when a customer clicks the link in your email.
...
=== "Shopify"
    ...
    !!! info "What is a Chat Popup?"
        ...
        A quiz popup that opens when a customer clicks a chat-like button.
    ...
    **On a specific page**{ #chat-on-a-specific-page }
    ...
    !!! tip "Step-by-step instructions"
        ...
        Follow the step by step instructions provided in our [How to Set Up Chat Button Popups on a Specific Page](/how-to-guides/publish-quiz-chat-button/#on-a-specific-page) to add a chat popup to your website.
