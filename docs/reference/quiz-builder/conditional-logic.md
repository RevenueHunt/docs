...
=== "Shopify"
    ...
    !!! info "Conditional logic does not include display logic"

        This tab holds jump logic and skip logic. You set display logic on the
        results page itself.
...
=== "Shopify (Legacy)"
    ...
    !!! info "Conditional Logic does not include Display Logic"
        ...
        Jump Logic and Skip Logic are triggered by an **IF** condition based on
        an answer. Display Logic acts on individual blocks.
...
=== "Shopify"
    ...
    **Type 3: IF the variable with the highest score...**
    ...
    !!! info
        ...
        Scores and variables are assigned to each choice in the [Questions](/reference/quiz-builder/questions/) tab > [Choice settings](/reference/quiz-builder/questions/#choice-settings) section.
