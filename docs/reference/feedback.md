---
description: "Send a bug report, a feature request or a new app idea to the RevenueHunt product team from the Feedback page in the app."
---

# Feedback

The Feedback page sends a message straight to the RevenueHunt product team. Use it to report a bug, to request a feature, or to suggest a new app.
...
=== "Shopify"
    ...
    - `New app idea` - A product idea for RevenueHunt to build.
    - `Something else` - Anything the other three topics do not cover.

    `Your message` - Describe what you want to be able to do, and what you are trying to achieve. A concrete example of your store and your customers helps the team more than a general request.

    `Your email` - The address the team replies to. The app fills in your account email, and you can change it.

    `Send feedback` - Click to send the message to the team.
