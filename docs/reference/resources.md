---
description: "The RevenueHunt Resources page: the quiz ROI calculator, the Shopify quizzes benchmark report, free quiz templates and recommended Shopify apps."
---

# Resources

The Resources page collects the tools, reports and templates that help you plan a quiz. It also lists Shopify apps that work well alongside a quiz.
...
=== "Shopify"
    ...
    **Recommended apps**
    ...
    This section lists Shopify apps that pair well with a quiz, grouped by what they do. `Upsell & recommendations` is one such group. It holds apps that raise average order value with cart upsells, wishlists and pre-orders.

    Each card describes one app. Click `Install app` to open its listing in the Shopify App Store.

    !!! info "The recommended apps change"

        RevenueHunt updates this list, so the apps on your screen can differ from the screenshot. These are apps from other companies, and those companies support them.
