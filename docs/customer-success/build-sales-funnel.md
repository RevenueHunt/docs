...
title: "How to Build an Ecommerce Sales Funnel"
description: "Build an ecommerce sales funnel that converts: the five stages, the strategic choices, the step-by-step build, and the five metrics that tell you what to fix. Works on Shopify, WooCommerce, and more."
---
...
<svg viewBox="0 0 440 760" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:auto; display:block;" role="img" aria-labelledby="fst fsd" preserveAspectRatio="xMidYMid meet">
  <title id="fst">The five stages of an ecommerce sales funnel</title>
  <desc id="fsd">Attention, Interest, Desire, Action, and Retention, in sequence. Desire (the results page) is the leverage point most stores miss.</desc>
  <defs>
    <marker id="fs-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M0,0 L10,5 L0,10 z" fill="#94a3b8"/></marker>
  </defs>
  <g font-family="system-ui, sans-serif">
    <g transform="translate(10 10)"><rect width="420" height="108" rx="12" fill="#ffffff" stroke="#e2e8f0" stroke-width="1.5"/><text x="22" y="34" font-size="12" font-weight="700" fill="#904E95" letter-spacing="1">STAGE 1</text><text x="22" y="66" font-size="21" font-weight="700" fill="#16161D">Attention</text><text x="22" y="94" font-size="14" fill="#334155">An ad or link brings them in.</text></g>
    <line x1="220" y1="120" x2="220" y2="148" stroke="#cbd5e1" stroke-width="2" marker-end="url(#fs-arrow)"/>
    <g transform="translate(10 152)"><rect width="420" height="108" rx="12" fill="#ffffff" stroke="#e2e8f0" stroke-width="1.5"/><text x="22" y="34" font-size="12" font-weight="700" fill="#904E95" letter-spacing="1">STAGE 2</text><text x="22" y="66" font-size="21" font-weight="700" fill="#16161D">Interest</text><text x="22" y="94" font-size="14" fill="#334155">They take the quiz and share answers.</text></g>
    <line x1="220" y1="262" x2="220" y2="290" stroke="#cbd5e1" stroke-width="2" marker-end="url(#fs-arrow)"/>
    <g transform="translate(10 294)"><rect width="420" height="108" rx="12" fill="#F6F0F7" stroke="#904E95" stroke-width="1.5"/><text x="22" y="34" font-size="12" font-weight="700" fill="#904E95" letter-spacing="1">STAGE 3</text><text x="22" y="66" font-size="21" font-weight="700" fill="#16161D">Desire</text><text x="22" y="94" font-size="14" fill="#334155">The results page sells the set.</text></g>
    <line x1="220" y1="404" x2="220" y2="432" stroke="#cbd5e1" stroke-width="2" marker-end="url(#fs-arrow)"/>
    <g transform="translate(10 436)"><rect width="420" height="108" rx="12" fill="#ffffff" stroke="#e2e8f0" stroke-width="1.5"/><text x="22" y="34" font-size="12" font-weight="700" fill="#904E95" letter-spacing="1">STAGE 4</text><text x="22" y="66" font-size="21" font-weight="700" fill="#16161D">Action</text><text x="22" y="94" font-size="14" fill="#334155">Checkout, plus a post-purchase upsell.</text></g>
    <line x1="220" y1="546" x2="220" y2="574" stroke="#cbd5e1" stroke-width="2" marker-end="url(#fs-arrow)"/>
...
- **Recommend a set, not a single SKU.** Use [slots for a routine](/customer-success/recommend-bundles-kits/) and a single "add all to cart" action.
...
=== "Shopify"
    ...
    - **Subscriptions:** recommend [Recharge](/how-to-guides/recommend-subscription-products/) products on the results page for recurring orders.
    - **Discounts:** sync your store's [automatic discount codes](/how-to-guides/add-discount/) so they apply at checkout for quiz finishers.
    - **Post-purchase:** use Shopify's native post-purchase offer page (or a post-purchase upsell app) for the one-click cross-sell.
    - **Multiple markets:** [Shopify Markets handles language and currency](/customer-success/adapt-quizzes-to-markets/).

=== "Shopify (Legacy)"

    - **Subscriptions:** recommend [Recharge](/how-to-guides/recommend-subscription-products/) products on the results page for recurring orders.
    - **Discounts:** sync your store's [automatic discount codes](/how-to-guides/add-discount/) so they apply at checkout for quiz finishers.
    - **Post-purchase:** use a post-purchase upsell app for the order-confirmation cross-sell.
    - **Multiple markets:** [Shopify Markets handles language and currency](/customer-success/adapt-quizzes-to-markets/).

=== "WooCommerce"

    - **Subscriptions:** recommend [WooCommerce Subscriptions](/how-to-guides/recommend-subscription-products/) products on the results page.
...
=== "Magento"
    ...
    - **Subscriptions:** not yet supported in the quiz. Use the [workaround](/how-to-guides/recommend-subscription-products/#other-subscriptions) of linking to a subscription product page from the results.
...
You only need five metrics. If one is degrading, that is the stage to invest in next. Track them in the [quiz metrics panel](/customer-success/track-quiz-metrics-for-better-conversions/).

| Metric | Formula | Healthy | If it's off |
|--------|---------|---------|-------------|
| **Quiz-start rate** | starts / sessions | 5-10%+ | The entry CTA or visibility is the bottleneck |
| **Completion rate** | completions / starts | 60-70%+ | Too many or too friction-heavy questions ([reduce drop-off](/customer-success/reduce-dropoff/)) |
...
- **Don't** build it once and forget. Quiz length, results copy, upsell offers, and email subjects all need [A/B testing](/how-to-guides/ab-test-quiz/) over time.
...
Need a hand building yours? [Contact our support team](/how-to-guides/contact-customer-support/) and we'll advise you.
