...
- **[Convert the lead](/customer-success/convert-leads-to-customers/)** with a follow-up that speaks to their skin, and time reorder reminders to when products run out. Build the [replenishment and cross-sell flows in Klaviyo](/how-to-guides/send-klaviyo-post-quiz-email-flows/#4-time-to-reorder).
