...
description: "Turn quiz leads into customers: send instant results, write a post-quiz email flow that does one job per send, segment it on quiz answers, recover the leads who slip away, and measure what actually converts."
---
...
- **Zero-party data:** what the shopper told you (skin type, goals, budget, preferences). See [what data is worth collecting](/customer-success/what-data-to-collect/).
...
3. Enable **Send Results Email** and personalize it with dynamic product images, titles, and prices.
...
!!! tip "Require the email, don't make it optional"
...
Instant results close the warmest shoppers. The follow-up flow closes the rest. Connect the quiz to [Klaviyo](/how-to-guides/send-leads-to-klaviyo/) or [another CRM](/how-to-guides/send-leads-to-crm/), where quiz answers and recommended products sync as profile properties so you can segment (for example, "dry skin and prefers vegan") and personalize.

!!! success "Connecting a CRM is worth the setup"
...
<svg viewBox="0 0 380 660" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:auto; display:block;" role="img" aria-labelledby="flt fld" preserveAspectRatio="xMidYMid meet">
  <title id="flt">A post-quiz email flow over three weeks</title>
  <desc id="fld">Five emails after the quiz: results immediately, education at 1 to 2 days, social proof at 3 to 5 days, an incentive at 5 to 7 days, and a retention email at 2 to 3 weeks.</desc>
  <g font-family="system-ui, sans-serif">
    <text x="20" y="34" font-size="17" font-weight="700" fill="#16161D">A post-quiz email flow</text>
    <line x1="40" y1="90" x2="40" y2="610" stroke="#e2e8f0" stroke-width="3"/>
    <circle cx="40" cy="100" r="11" fill="#904E95"/>
    <text x="72" y="96" font-size="16" font-weight="700" fill="#16161D">Results</text>
    <text x="72" y="118" font-size="13" fill="#64748b">Immediately</text>
    <circle cx="40" cy="225" r="11" fill="#904E95"/>
    <text x="72" y="221" font-size="16" font-weight="700" fill="#16161D">Education</text>
    <text x="72" y="243" font-size="13" fill="#64748b">1-2 days later</text>
    <circle cx="40" cy="350" r="11" fill="#904E95"/>
    <text x="72" y="346" font-size="16" font-weight="700" fill="#16161D">Social proof</text>
    <text x="72" y="368" font-size="13" fill="#64748b">3-5 days later</text>
    <circle cx="40" cy="475" r="11" fill="#904E95"/>
    <text x="72" y="471" font-size="16" font-weight="700" fill="#16161D">Incentive</text>
    <text x="72" y="493" font-size="13" fill="#64748b">5-7 days later</text>
    <circle cx="40" cy="600" r="11" fill="#904E95"/>
    <text x="72" y="596" font-size="16" font-weight="700" fill="#16161D">Retention</text>
    <text x="72" y="618" font-size="13" fill="#64748b">2-3 weeks later</text>
  </g>
</svg>
</div>
...
<div style="margin:24px auto; max-width:380px;">
<svg viewBox="0 0 380 380" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:auto; display:block;" role="img" aria-labelledby="sgt sgd" preserveAspectRatio="xMidYMid meet">
  <title id="sgt">One follow-up flow split by the quiz answer</title>
  <desc id="sgd">A single quiz lead branches by answer into dry skin, oily skin, and sensitive segments, each receiving tailored products and proof.</desc>
  <defs>
    <marker id="sg-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M0,0 L10,5 L0,10 z" fill="#94a3b8"/></marker>
  </defs>
  <g font-family="system-ui, sans-serif">
    <g transform="translate(10 8)"><rect width="360" height="64" rx="12" fill="#F6F0F7" stroke="#904E95" stroke-width="1.5"/><text x="20" y="28" font-size="11" font-weight="700" fill="#904E95" letter-spacing="1">ONE FLOW</text><text x="20" y="52" font-size="17" font-weight="700" fill="#16161D">Quiz lead + their answers</text></g>
    <line x1="40" y1="72" x2="40" y2="327" stroke="#cbd5e1" stroke-width="2"/>
    <line x1="40" y1="135" x2="108" y2="135" stroke="#cbd5e1" stroke-width="2" marker-end="url(#sg-arrow)"/>
    <line x1="40" y1="231" x2="108" y2="231" stroke="#cbd5e1" stroke-width="2" marker-end="url(#sg-arrow)"/>
    <line x1="40" y1="327" x2="108" y2="327" stroke="#cbd5e1" stroke-width="2" marker-end="url(#sg-arrow)"/>
    <g transform="translate(110 100)"><rect width="260" height="70" rx="10" fill="#ffffff" stroke="#e2e8f0" stroke-width="1.5"/><text x="18" y="30" font-size="16" font-weight="700" fill="#16161D">Dry skin</text><text x="18" y="52" font-size="13" fill="#64748b">Hydration routine, dry-skin reviews</text></g>
    <g transform="translate(110 196)"><rect width="260" height="70" rx="10" fill="#ffffff" stroke="#e2e8f0" stroke-width="1.5"/><text x="18" y="30" font-size="16" font-weight="700" fill="#16161D">Oily skin</text><text x="18" y="52" font-size="13" fill="#64748b">Mattifying set, oily-skin reviews</text></g>
    <g transform="translate(110 292)"><rect width="260" height="70" rx="10" fill="#ffffff" stroke="#e2e8f0" stroke-width="1.5"/><text x="18" y="30" font-size="16" font-weight="700" fill="#16161D">Sensitive</text><text x="18" y="52" font-size="13" fill="#64748b">Fragrance-free set, gentle-routine proof</text></g>
  </g>
</svg>
</div>

You don't need a separate flow per segment. Build one flow and use conditional splits on the quiz property, so a dry-skin lead and an oily-skin lead get the email that fits them at each step. Start with the one attribute that most changes what you'd recommend (skin type, goal, pet, budget tier) and add splits from there. To get those attributes into the CRM in the first place, see [collect data worth money with customer tags](/customer-success/use-customer-tags-in-quiz/).
...
!!! tip "Add SMS for the time-sensitive moments"
    For opted-in shoppers, SMS converts fast on the incentive and the restock reminder, where minutes matter. Keep it to those two moments so it stays welcome, and collect SMS consent separately from email. See [how to ask for marketing consent the right way](/customer-success/ask-marketing-consent/).
...
Track the on-site half of this (starts, completions, quiz-attributed revenue) in the [quiz metrics panel](/customer-success/track-quiz-metrics-for-better-conversions/), and the email half in your CRM.
...
**Where to go next:** turn these segments into cheaper ads with [use quiz data to lower your ad costs](/customer-success/use-quiz-data-for-ads/), or raise each order with [bundles, kits & routines](/customer-success/recommend-bundles-kits/).
