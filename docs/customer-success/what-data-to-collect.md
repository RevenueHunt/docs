...
<svg viewBox="0 0 440 420" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:auto; display:block;" role="img" aria-labelledby="wdt wdd" preserveAspectRatio="xMidYMid meet">
  <title id="wdt">The one rule for keeping a quiz question</title>
  <desc id="wdd">A quiz question is kept only if its answer changes a recommendation, a segment, or a message; otherwise it is cut.</desc>
  <defs>
    <marker id="wd-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0,0 L10,5 L0,10 z" fill="#94a3b8"/></marker>
  </defs>
  <g font-family="system-ui, sans-serif">
    <rect x="110" y="20" width="220" height="64" rx="10" fill="#ffffff" stroke="#e2e8f0" stroke-width="1.5"/>
    <text x="220" y="58" font-size="16" font-weight="700" fill="#16161D" text-anchor="middle">Any quiz question</text>
    <line x1="220" y1="86" x2="220" y2="116" stroke="#cbd5e1" stroke-width="2" marker-end="url(#wd-arrow)"/>
    <rect x="40" y="120" width="360" height="116" rx="10" fill="#ffffff" stroke="#e2e8f0" stroke-width="1.5"/>
    <text x="220" y="160" font-size="15" fill="#334155" text-anchor="middle">Does the answer change a</text>
    <text x="220" y="183" font-size="15" fill="#334155" text-anchor="middle">recommendation, a segment,</text>
    <text x="220" y="206" font-size="15" fill="#334155" text-anchor="middle">or a message?</text>
    <line x1="160" y1="238" x2="130" y2="296" stroke="#cbd5e1" stroke-width="2" marker-end="url(#wd-arrow)"/>
    <line x1="280" y1="238" x2="310" y2="296" stroke="#cbd5e1" stroke-width="2" marker-end="url(#wd-arrow)"/>
    <rect x="30" y="300" width="180" height="72" rx="10" fill="#F6F0F7" stroke="#904E95" stroke-width="1.5"/>
    <text x="120" y="343" font-size="16" font-weight="700" fill="#16161D" text-anchor="middle">Yes, keep it</text>
    <rect x="230" y="300" width="180" height="72" rx="10" fill="#f8fafc" stroke="#cbd5e1" stroke-width="1.5"/>
...
- **The problem or goal.** "What are you trying to solve?" This frames the whole result and is your most powerful [segment](/customer-success/use-customer-tags-in-quiz/).
- **The attribute that maps to a product.** Skin type, hair type, size, dietary need, room dimensions, skill level. This is what your [recommendation logic](/how-to-guides/recommend-products/) uses to pick the right item.
...
- **Contact details, with consent.** The email or phone, captured the [right way](/customer-success/ask-marketing-consent/), is what turns an anonymous session into a lead you can re-engage.
...
### How do I decide which questions to keep?

Keep a question only if its answer changes a recommendation, a segment, or a message. If you can't name what it changes, cut it.

### What data is most worth collecting?
...
**Learn more:** [12 zero-party data examples to steal](https://revenuehunt.com/zero-party-data-examples/){target=_blank} · [Quiz & ecommerce glossary](https://revenuehunt.com/glossary/){target=_blank}

**Where to go next:** put the data to work and [lower your ad costs →](/customer-success/use-quiz-data-for-ads/)
