...
![A giveaway promotion tied to quiz completion](https://revenuehunt.com/img/blog/11-easy-ways-to-promote-your-quiz-and-get-more-people-to-take-it/Pink-Minimalist-Abstract-Giveaway-Time-Instagram-Post-300x300.webp){ width="280" }
...
Send paid ads to a dedicated quiz page rather than to a product page or homepage. Quiz finishers convert at roughly 2.75x non-takers, so the same ad click is worth far more pointed at the quiz - and the quiz captures email and preferences you can retarget with. See [Use quiz data to lower your ad costs](/customer-success/use-quiz-data-for-ads/).
