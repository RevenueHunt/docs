---
description: "A gift finder quiz playbook: recipient-based questions, recommending a confident shortlist across price tiers, and capturing the gifter for future occasions."
---
...
- Offer **gift sets and bundles** as an easy upgrade. See the [bundles, kits & routines](/customer-success/recommend-bundles-kits/) playbook and [Set up recommendations](/how-to-guides/set-up-recommendations/).
...
- **[Re-engage seasonally](/customer-success/convert-leads-to-customers/)**, prompting them before the next holiday or that recipient's birthday, using [tags](/customer-success/use-customer-tags-in-quiz/) to time it.
- **[Run gift-finder ads](/customer-success/use-quiz-data-for-ads/)** into the quiz during peak seasons, when intent is highest.
