...
=== "Shopify"
    ...
    Not applicable for the Built for Shopify version of the RevenueHunt app. It is **not possible** to show a quiz in the Shop App with the Built for Shopify version of the RevenueHunt app.
...
=== "WooCommerce"
    ...
    Not applicable for the WooCommerce version of the RevenueHunt app. It is **not possible** to show a quiz in the Shop App with the WooCommerce version of the RevenueHunt app.

=== "Magento"

    Not applicable for the Magento version of the RevenueHunt app. It is **not possible** to show a quiz in the Shop App with the Magento version of the RevenueHunt app.

=== "BigCommerce"


    Not applicable for the BigCommerce version of the RevenueHunt app. It is **not possible** to show a quiz in the Shop App with the BigCommerce version of the RevenueHunt app.

=== "Standalone"

    Not applicable for the Standalone version of the RevenueHunt app. It is **not possible** to show a quiz in the Shop App with the Standalone version of the RevenueHunt app.
