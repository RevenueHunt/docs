...
This article explains how to create an external quiz link that you can share on social media, such as TikTok, X, Instagram and Facebook.

!!! info "What is an External Quiz Link?"

    It is a link that opens the quiz on your website.
...
=== "Shopify"
    ...
    4. **Copy the link to the quiz popup**: The direct link to your quiz popup is https://yourstore.myshopify.com/#quiz.
        ...
        !!! tip
            ...
            To link to a specific quiz, add `#quiz-QUIZID` to the store URL.

            For example, `https://yourstore.myshopify.com/#quiz-123` opens one quiz, and `https://yourstore.myshopify.com/#quiz-456` opens another.
...
=== "Shopify (Legacy)"
    ...
    1. **Activate App Embeds**: Go to `Online Store > Theme > Customize > App Embeds` in Shopify. Find `Link Popup Quiz (Legacy)` and toggle it on.
    2. **Obtain the Popup Link Code**: Go to the [`Share`](/reference/quiz-builder/share-publish/) section of the Quiz Builder, then open the [`External`](/reference/quiz-builder/share-publish/#external) tile and `Show Instructions for legacy themes`.
    2. **Customize Popup Dimensions**: Set the width and height to suit the social media platform you plan to use.
    3. **Generate popup link**: Click `Get the code` to create your quiz link. The link is then ready to share.
    4. **Share on Social Media**: Copy the link. Paste it into your posts on X, Instagram, Facebook or any other platform.
...
=== "Magento"
    ...
    3. **Customize Popup Dimensions**: Set the width and height to suit the social media platform you plan to use.
    4. **Generate popup link**: Click `Get the code` to create your quiz link. The link is then ready to share.
    5. **Share on Social Media**: Copy the link. Paste it into your posts on X, Instagram, Facebook or any other platform.
...
=== "Standalone"
    ...
    2. **Obtain the Popup Link Code**: Go to the [`Share`](/reference/quiz-builder/share-publish/) section of the app, then open the [`External`](/reference/quiz-builder/share-publish/#external) tile.
    3. **Customize Popup Dimensions**: Set the width and height to suit the social media platform you plan to use.
    4. **Generate popup link**: Click `Get the code` to create your quiz link. Add your own website URL, so it reads `https://yourwebsite.com/#quiz-QUIZID/`. The link is then ready to share.
    5. **Share on Social Media**: Copy the link. Paste it into your posts on X, Instagram, Facebook or any other platform.
