...
=== "Shopify"
    ...
    !!! info "Short Instructions"
        ...
        **Note:** If you've configured [Shopify Markets](/reference/app-settings/#__tabbed_5_2), the default quiz for that specific market will be shown instead.
        ...
        If you'd like a specific quiz to open instead of the default, check [Open a specific quiz](#open-a-specific-quiz).
    ...
    6. **Insert the #quiz Code**: Type `#quiz` into the link field and then click on `Save`.
        ...
        !!! note
            ...
            When clicked, #quiz will open the default quiz for your store. If you've configured [Shopify Markets](/reference/app-settings/#__tabbed_5_2), the default quiz for that specific market will be shown instead. If you'd like a specific quiz to open instead of the default, check [Open a specific quiz](#open-a-specific-quiz).
