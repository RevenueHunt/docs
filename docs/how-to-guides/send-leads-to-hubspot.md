...
=== "Shopify"
    ...
    Connect your quiz to HubSpot and every quiz result is sent to your HubSpot account. You can then segment your contacts on their answers, and write a campaign for each group.

    This article explains how to connect your store to HubSpot. It also covers turning the integration on for a quiz, and adding contacts to a HubSpot list.
    ...
    - Access to your quiz in the RevenueHunt app.
...
=== "Shopify (Legacy)"
    ...
    This article explains how to link your quiz to HubSpot, so you can follow up on every response.
...
=== "Shopify (Legacy)"
    ...
    **Custom properties**
    ...
    ??? warning "Quiz data is not showing up in HubSpot?"

        If one property in the payload does not exist in your portal, HubSpot rejects the **entire** sync. When some or all of the quiz data is missing, check that you created every property in the table. Check too that you used the internal name, such as `q_lvps1n_what_is_your_skin_type`, rather than the label.
