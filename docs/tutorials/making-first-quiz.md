...
=== "Shopify"
    ...
    6. To make the quiz more personal you can add a `Name question` and recall the answer in other parts of the quiz using [content dynamic source](/how-to-guides/use-information-recalls/).
...
=== "Shopify"
    ...
    3. Your store's products will appear as a list. Scroll down to select items or just start typing the name.
...
=== "Shopify"
    ...
    10. You can now test the quiz on the live site by clicking the link in the menu.
