...
=== "Shopify"
    ...
    In this tutorial, you'll learn how to connect your RevenueHunt account to [Klaviyo](/how-to-guides/send-leads-to-klaviyo/) via OAuth and set up a post-quiz email flow.
