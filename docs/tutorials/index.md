...
About to create your first Product Recommendation Quiz and not sure where to start? These tutorials show you step by step how to use the app.
...
[:fontawesome-solid-arrow-right: Getting started](/tutorials/getting-started/)
...
[:fontawesome-solid-arrow-right: How to build a successful quiz](/customer-success/how-to-build-successful-quiz/)
...
[:fontawesome-solid-arrow-right: Recommending a skincare routine](/tutorials/skincare-routine/)

### [Building a skin type quiz](/tutorials/skintype-quiz/)

Make and publish a quiz that works out a customer's skin type, then recommends a group of complementary products.

[:fontawesome-solid-arrow-right: Building a skin type quiz](/tutorials/skintype-quiz/)


### [Using conditional logic](/tutorials/conditional-logic/)

Learn how to use Jump Logic, Skip Logic and Display Logic to show or hide questions and content, both in the quiz and on the Results Page.

[:fontawesome-solid-arrow-right: Using conditional logic](/tutorials/conditional-logic/)

### [Sending emails](/tutorials/sending-emails/)

Learn how to send emails to your quiz leads with the RevenueHunt app.

[:fontawesome-solid-arrow-right: Sending emails](/tutorials/sending-emails/)

### [Sending follow-up emails with Klaviyo](/tutorials/follow-up-emails-klaviyo/)

Learn how to add RevenueHunt app leads to Klaviyo, and how to build a post-quiz email flow there.

[:fontawesome-solid-arrow-right: Sending follow-up emails with Klaviyo](/tutorials/follow-up-emails-klaviyo/)
