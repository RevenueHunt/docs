...
- **[Convert and retain](/customer-success/convert-leads-to-customers/)** with reorder reminders timed to when a bottle runs out, and education that keeps them on the regimen. Build it as a [replenishment flow in Klaviyo](/how-to-guides/send-klaviyo-post-quiz-email-flows/#4-time-to-reorder).
