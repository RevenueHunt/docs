...
This Data Processing Agreement ("DPA") forms part of the Terms of Service available at https://revenuehunt.com/tos/ (the "Agreement") between:
...
**You** ("Controller", "Customer", or "Merchant")
The entity that has agreed to the Agreement
